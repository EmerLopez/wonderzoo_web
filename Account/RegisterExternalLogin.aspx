<%@ Page Title="Registrar un inicio de sesión externo" Language="C#" MasterPageFile="~/principal.Master" AutoEventWireup="true" CodeBehind="RegisterExternalLogin.aspx.cs" Inherits="wonderzoo_web.Account.RegisterExternalLogin" Async="true" %>
