...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="row">
        <div class="col-md-4" style="background-position: center; background-size: cover; left: 0px; top: 0px; background-image: url('images/vertebrados.png')">
            <h2>
                <a class="btn btn-default" href="https://go.microsoft.com/fwlink/?LinkId=301948" style="border-style: outset; background-color: #CCF85D">Vertebrados &raquo;</a></h2>
            <p>&nbsp;</p>
            <p>
                &nbsp;</p>
            <p>
        ...
        <div class="col-md-4" style="background-position: center; background-size: cover; left: 0px; top: 0px; background-image: url('images/viviparos.png')">
            <h2>
                <a class="btn btn-default" href="https://go.microsoft.com/fwlink/?LinkId=301949" style="background-color: #CCF85D; border-style: outset">Viviparos &raquo;</a></h2>
            <p>&nbsp;</p>
            <p>
                &nbsp;</p>
            <p>
