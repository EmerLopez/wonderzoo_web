<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="terminos.aspx.cs" Inherits="wonderzoo_web.terminos" %>
...
<body>
    <form id="form1" runat="server">
            ...
            <asp:Label ID="Label1" runat="server" Text="Terminos y Condiciones" Enabled="False" CssClass="nuevoEstilo1"></asp:Label>
        
        <p>

            <asp:TextBox ID="TextBox1" runat="server" Height="474px" Width="894px" TextMode="MultiLine" BackColor="#FFFFC0" CssClass="nuevoEstilo8">El sitio web utiliza cookies para ayudar a personalizar tu experiencia en línea. Al acceder a FENAHEC_SV, aceptaste utilizar las cookies necesarias.
...
Licencia:
A menos que se indique lo contrario, FENAHEC_SV y/o sus licenciantes poseen los derechos de propiedad intelectual de todo el material en FENAHEC_SV. Todos los derechos de propiedad intelectual son reservados. Puedes acceder desde FENAHEC_SV para tu uso personal sujeto a las restricciones establecidas en estos términos y condiciones.

No debes:

Copiar o volver a publicar material de FENAHEC_SV
Vender, alquilar o sublicenciar material de FENAHEC_SV
Reproducir, duplicar o copiar material de FENAHEC_SV
Redistribuir contenido de FENAHEC_SV
Este acuerdo comenzará el fecha presente.

Partes de este sitio web ofrecen a los usuarios la oportunidad de publicar e intercambiar opiniones e información en determinadas áreas. FENAHEC_SV no filtra, edita, publica ni revisa los comentarios antes de su presencia en el sitio web. Los comentarios no reflejan los puntos de vista ni las opiniones de FENAHEC_SV, sus agentes y/o afiliados. Los comentarios reflejan los puntos de vista y opiniones de la persona que publica. En la medida en que lo permitan las leyes aplicables, FENAHEC_SV no será responsable de los comentarios ni de ninguna responsabilidad, daños o gastos causados ​​o sufridos como resultado de cualquier uso o publicación o apariencia de comentarios en este sitio web.

FENAHEC_SV se reserva el derecho de monitorear todos los comentarios y eliminar los que puedan considerarse inapropiados, ofensivos o que incumplan estos Términos y Condiciones.
...
Por la presente, otorgas a FENAHEC_SV una licencia no exclusiva para usar, reproducir, editar y autorizar a otros a usar, reproducir y editar cualquiera de tus comentarios en todas y cada una de las formas, formatos, o medios.
...
Si eres una de las organizaciones enumeradas en el párrafo 2 y estás interesada en vincularte a nuestro sitio web, debes informarnos enviando un correo electrónico a FENAHEC_SV. Incluye tu nombre, el nombre de tu organización, la información de contacto, así como la URL de tu sitio, una lista de las URL desde las que tienes la intención de vincular a nuestro sitio web y una lista de las URL de nuestro sitio a las que te gustaría acceder. Espera 2-3 semanas para recibir una respuesta.
...
No se permitirá el uso del logotipo de FENAHEC_SV u otro material gráfico para vincular sin un acuerdo de licencia de marca comercial.
...
Siempre que el sitio web y la información y los servicios en el sitio se proporcionen de forma gratuita, no seremos responsables de ninguna pérdida o daño de cualquier naturaleza.
  ...
  <a href="default"><input type="button" value="Volver" class="nuevoEstilo9" style="#CCF85D; background-color: #CCF85D;"></a>
    </form>
    <style> 
        body {
            background-color: #74F882 ;
